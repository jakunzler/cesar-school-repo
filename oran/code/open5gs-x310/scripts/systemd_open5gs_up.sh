...
# Inicia todos os serviços Open5GS cujos unit files aparecem em systemd.
...
echo "Unidades Open5GS que serão iniciadas (${#units[@]}):"
printf '  - %s\n' "${units[@]}"
echo
...
echo
echo "Resumo: ${ok} iniciado(s) com sucesso, ${fail} falha(s)."
