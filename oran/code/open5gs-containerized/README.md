...
```bash
git clone https://github.com/jakunzler/especializacao_oran.git
```
...
```bash
cd especializacao_oran/code/open5gs-containerized/core
./scripts/up_core.sh
```
...
```bash
cd especializacao_oran/code/open5gs-containerized/ueransim
./scripts/up_ran.sh
```
