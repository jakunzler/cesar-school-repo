...
void fix_scc(NR_ServingCellConfigCommon_t *scc, uint64_t ssbmap)
{
  ...
  // by default, select ra_ResponseWindow automatically; otherwise convert config slot value to ASN.1 enum
  if (rach_ConfigCommon->rach_ConfigGeneric.ra_ResponseWindow < 0) {
    ...
    // Config file uses slot values (1,2,4,8,10,20,40,80); ASN.1 uses enum (sl1..sl80 = 0..7)
    long v = rach_ConfigCommon->rach_ConfigGeneric.ra_ResponseWindow;
    long enum_val = -1;
    switch (v) {
      case 1:  enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl1;  break;
      case 2:  enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl2;  break;
      case 4:  enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl4;  break;
      case 8:  enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl8;  break;
      case 10: enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl10; break;
      case 20: enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl20; break;
      case 40: enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl40; break;
      case 80: enum_val = NR_RACH_ConfigGeneric__ra_ResponseWindow_sl80; break;
      default:
        AssertFatal(false, "ra_ResponseWindow must be one of 1,2,4,8,10,20,40,80, got %ld\n", v);
    }
    rach_ConfigCommon->rach_ConfigGeneric.ra_ResponseWindow = enum_val;
  }
