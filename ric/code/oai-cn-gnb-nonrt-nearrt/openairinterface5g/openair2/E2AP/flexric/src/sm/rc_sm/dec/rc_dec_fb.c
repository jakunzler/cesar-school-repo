...
e2sm_rc_event_trigger_t rc_dec_event_trigger_fb(size_t len, uint8_t const ev_tr[len])
{
  ...
  assert(ev_tr != NULL);
  e2sm_rc_event_trigger_t avoid_warning;
  return avoid_warning;
}

rc_action_def_t rc_dec_action_def_fb(size_t len, uint8_t const action_def[len])
{
  assert(0!=0 && "Not implemented");
  assert(action_def != NULL);
  rc_action_def_t avoid_warning;
  return avoid_warning;
}
...
rc_ctrl_out_t rc_dec_ctrl_out_fb(size_t len, uint8_t const ctrl_out[len]) 
{
  assert(0!=0 && "Not implemented");
...
rc_func_def_t rc_dec_func_def_fb(size_t len, uint8_t const func_def[len])
{
  assert(0!=0 && "Not implemented");
