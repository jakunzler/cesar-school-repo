...
int
asn_generic_no_constraint_e2ap_v2_03(const asn_TYPE_descriptor_t *type_descriptor,
...
int
asn_generic_unknown_constraint_e2ap_v2_03(const asn_TYPE_descriptor_t *type_descriptor,
                               const void *struct_ptr,
                               asn_app_constraint_failed_f *cb, void *key) {
    (void)type_descriptor;	/* Unused argument */
	(void)struct_ptr;	/* Unused argument */
...
int
asn_check_constraints_e2ap_v2_03(const asn_TYPE_descriptor_t *type_descriptor,
